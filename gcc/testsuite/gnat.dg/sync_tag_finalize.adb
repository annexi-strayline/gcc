--  In previous versions of GNAT there was a curious bugs that caused
...
--  failed compilation.
--
--  TL;DR: When creating an (implicit) constrained subtype of a synchronized
--  private extension with known non-defaulted disciminants, the class-wide TSS
